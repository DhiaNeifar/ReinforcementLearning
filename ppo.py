...
if __name__ == "__main__":
    ...
    torch.backends.cudnn.deterministic = args.torch_deterministic # For reproducibility purposes.
    ...
    # -----------------------------------------------------------
    # Save the final model next to the TensorBoard logs
    # -----------------------------------------------------------
    ...
    # 2. Use the same run_name that was used for SummaryWriter and wandb
    model_path = model_dir / f"{run_name}.pth"

    # 3. Save the policy and arguments
    torch.save(
        {
